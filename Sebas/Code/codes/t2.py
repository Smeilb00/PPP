...
def run():
    ...
    imagen_einstein = face_recognition.load_image_file("datapool/einstein/einstein.jpg")
    imagen_paul = face_recognition.load_image_file("datapool/paul/paul.jpg")
    imagen_planck = face_recognition.load_image_file("datapool/planck/planck.jpg")
